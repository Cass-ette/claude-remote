 ...
 *
 * Embedded as a string so the built output in dist/ has no runtime
 * dependency on reading the .sql file from disk. The .sql file with the
 * identical content lives alongside for review; a test asserts the two
 * stay in sync.
 */
